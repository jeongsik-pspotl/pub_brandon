...
@Slf4j
@Component
public class AgentFileSendUtil {
    ...
    public boolean getUrlRestAndroidAppFileUrl(String url, MultiValueMap<String, Object> reqToFileObj){
        ...
        String totalUrl = url+"/whiveFileUpload"; // 수정 해야함....
        log.info(totalUrl);
        try {
    ...
    // ftpSetting
    public boolean upload(InputStream insFileObj, String fileName, String platform, String projectPath, JSONObject ftpSettingObj) throws Exception {
        ...
        try {
            ...
            if(platform.toLowerCase().equals(PayloadMsgType.ios.name()) && appUpload){
                plistUpload = createPlistFile(ftpClient, savePathAll, projectPath, changeToFileName, ftpSettingObj);
            }
    ...
    private boolean createPlistFile(FTPClient ftpClient, String path, String projectPath, String appName, JSONObject ftpSettingObj) throws IOException {
        File fplist = null;
        ...
        try {
            ...
            out.append("<string>inswave.whive.presentation</string>"+"\n");
