...
import com.pspotl.sidebranden.builder.domain.DeployStatusMessage;
...
@Slf4j
@Async
public class DeployAndroidProcess implements Runnable {
    ...
    public DeployAndroidProcess(WebSocketSession session, CommandLine commandLine,
                                Map<String, Object> parseResult, int history_id, String hqKey, String androidDeployLogs){
        ...
        this.deployLogs = androidDeployLogs;
