...
public class AWSClientUtil {
    ...
    public String upload(MultipartFile multipartFile, String dirName, String setBucket) throws IOException {
        bucket = setBucket;
    ...
    private String putS3(File uploadFile, String fileName) {
        amazonS3Client.putObject(
                new PutObjectRequest(bucket, fileName, uploadFile)
                        .withCannedAcl(CannedAccessControlList.PublicRead).withStorageClass(StorageClass.IntelligentTiering)	// PublicRead 권한으로 업로드 됨
        );
