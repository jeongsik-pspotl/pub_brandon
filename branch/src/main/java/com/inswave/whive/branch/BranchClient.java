...
import com.inswave.whive.branch.handler.BranchSocketHandler;
import com.inswave.whive.branch.service.BuilderReconnectService;
...
@Component
@Configuration
public class BranchClient implements ApplicationRunner {
    ...
    private String branchClientAddress;
...
//        builderReconnectService = new BuilderReconnectService();
        ...
        try {
            branchClientAddress = InetAddress.getLocalHost().getHostAddress();
        ...
        log.info("branchClientAddress : {}, branchPort : {}",branchClientAddress, port);
    ...
    private boolean connectToHeadquarter(StandardWebSocketClient wsClient, String payload){
        ...
        try {
            ...
            log.info("BranchClient |run| session data {} ", session);
