...
public class IBMSystemInfo implements SystemInfoIF {

    private String osName;
    public static final String version = "1.00";
    public static final String buildDate = "2006-02-08";

    private static final Logger logger = LoggerFactory.getLogger(IBMSystemInfo.class);

    /**
     * Constructor for IBMSystemInfo.
     */
    public IBMSystemInfo(String osName) {
        this.osName = osName;
    }
