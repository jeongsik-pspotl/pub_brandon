/*amd /cm/ui/works/project_add_step03.xml 31191 c9dfab6ec40e9c1b5dc7cbc40ee3ce9823953301f1eac0b86f0656d7d5640d7a */
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',E:[{T:1,N:'w2:type',E:[{T:3,text:'COMPONENT'}]},{T:1,N:'w2:buildDate'},{T:1,N:'w2:MSA'},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',A:{baseNode:'map'}},{T:1,N:'w2:workflowCollection'}]},{T:1,N:'w2:layoutInfo'},{T:1,N:'w2:publicInfo',A:{method:''}},{T:1,N:'script',A:{lazy:'false',type:'text/javascript'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){
						...
						scwin.onpageload = function () {
							...
							const workspace_name = wframeParam.workspace_name;
							scwin.workspace_name = workspace_name;

							scwin.step01Data = $p.parent().dtl_build_project_step1.getAllJSON();
							const createBuildID = scwin.step01Data[0].project_id;
							const project_dir_name = scwin.step01Data[0].project_dir_path;
							const product_type = scwin.step01Data[0].product_type;
							const platform = scwin.step01Data[0].platform;
							scwin.platformType = platform;
							scwin.build_id = createBuildID;

							// buildID,platform,workspaceName,projectDirName이 없으면 진행하지 않음.
							if (common.util.isEmpty(createBuildID) && common.util.isEmpty(platform) && common.util.isEmpty(workspace_name) && common.util.isEmpty(project_dir_name)) {
								common.win.alert("step1,step2 입력데이터 중 누락된 값이 있습니다.");
								return;
							}
						...
						// 플러그인 정보 조회
						scwin.getTemplateProjectToPluginList = async function(data){
							const uri = common.uri.searchPluginList
							await common.http.fetch(uri,"POST",{"Content-Type":"application/json"},data);
						};

						scwin.getProjectToPluginList = async function (data) {
							const uri = common.uri.pluginlist;
						...
						scwin.setBuilderPluginListStatusNoBuildPage = function (data) {
							...
							switch (data.message) {
								...
								case "SUCCESSFUL":
									...
									scwin.installed_plugin_json = $p.parent().dtl_plugin_add_installed_step3.getAllJSON();
									scwin.available_plugin_json = $p.parent().dtl_plugin_add_available_step3.getAllJSON();
									scwin.available_premium_plugin_json = $p.parent().dtl_plugin_add_available_premium_step3.getAllJSON();
						...
						scwin.setpluginlisttag = function (data) {
							...
							$p.parent().dtl_plugin_add_installed_step3.removeAll();
							$p.parent().dtl_plugin_add_available_step3.removeAll();
							$p.parent().dtl_plugin_add_available_premium_step3.removeAll();

							$p.parent().dtl_plugin_add_installed_step3.setJSON(pluginAddInstalld, true);
							$p.parent().dtl_plugin_add_available_step3.setJSON(pluginAddAvailable, true);
							$p.parent().dtl_plugin_add_available_premium_step3.setJSON(pluginAddAvailablePremium,true);
						};
						...
						scwin.btn_apply_plugin_onclick = async function (e) {
							...
							if(scwin.pluginArray.length == 0){
								let message = common.getLabel("lbl_project_add_step03_js_add_del_plugin");
