/*amd /ui/history/history_list.xml 7810 1c5e3d3085d6c100319cab544a9610f0fb740787d6bdc7a029385be932da8c30 */
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',E:[{T:1,N:'w2:type',E:[{T:3,text:'COMPONENT'}]},{T:1,N:'w2:buildDate'},{T:1,N:'w2:MSA'},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',A:{baseNode:'map'}},{T:1,N:'w2:workflowCollection'}]},{T:1,N:'w2:layoutInfo'},{T:1,N:'w2:publicInfo',A:{method:''}},{T:1,N:'script',A:{lazy:'false',type:'text/javascript'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){
						scwin.onpageload = function() {
							...
							$('.acd_tit').click(function() {
								const acdbox = $(this).closest('.acdbox');
						...
						scwin.setWorkspace = function (workspace_json, buildproj_json) {
							for (const idx in workspace_json) {
								...
								for (const idx2 in buildproj_json) {
									if (buildproj_json[idx2].workspace_id == workspace_json[idx].id) {
										if (buildproj_json[idx2].build_yn == "1") {
											...
											grp_historyproj_btn.setUserData("workspace_pkid",workspace_json[idx].id);
											...
											btn_history.setUserData("workspace_pkid",workspace_json[idx].id);
											...
											if (buildproj_json[idx2].platform == "Android") {
												...
												const message = common.getLabel("lbl_android"); // Android
												span_icon.setValue(message);
												android_cnt++;
											} else {
												span_icon.addClass("ico_ios");

												const message = common.getLabel("lbl_ios"); // iOS
												span_icon.setValue(message);
												ios_cnt++;
											}
						...
						scwin.grp_list_link_onclick = function() {
							let controlList = this.parentControl.parentControl.childControlList;
